...
const RequestInfo = () => {
 ...
 const departments = [
  ...
  const handleCityChange = (event) => {
    ...
    const selectedDepartmentObject = departments.find(dep => dep.name === selectedDepartment);
    const isMedellin = selectedCity === 'Medellin';
    const showMunicipality = selectedDepartmentObject.name === 'Antioquia' && isMedellin;
    setShowMunicipalitySelect(showMunicipality);
  };
      ...
      <div className="col-6">
        ...
        />
          ...
          <NavLink to='/user/profile'>
            <button type="button" className="editdc btn btn-primary">
              Editar dirección
            </button>
           </NavLink>
        </form>
